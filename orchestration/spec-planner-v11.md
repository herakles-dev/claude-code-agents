...
> Full V11 task protocol (TaskList/TaskUpdate discipline, effort levels, risk/autonomy, verification steps) lives in `~/v11/CLAUDE.md` — this def assumes you already have it loaded and states only what's planner-specific.

## Pointers

[PROTOCOL_FUNDAMENTALS](~/v11/docs/PROTOCOL_FUNDAMENTALS.md) (task claiming, file ownership, verification, teammate comms) · [FORMATIONS](~/v11/docs/FORMATIONS.md) (formation-recipe detail) · [Task Claiming pattern](~/v11/patterns/task-claiming.md).
