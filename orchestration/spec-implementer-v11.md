...
> Full V11 task protocol (TaskList/TaskUpdate discipline, effort levels, risk/autonomy, verification steps) lives in `~/v11/CLAUDE.md` — this def assumes you already have it loaded and states only what's implementer-specific.
