...
| `docs-engineer.md` | Writes and maintains READMEs, API docs, changelogs, and architecture diagrams (Mermaid). Reach for it once a feature works and needs to be explained, not just shipped. |
